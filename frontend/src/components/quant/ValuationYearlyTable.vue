<template>
  <div class="valuation-yearly-table">
      ...
      <table>
        ...
        <tbody>
          ...
          >
            ...
            <td class="ratio-cell">{{ formatRatio(row.ev_to_revenue) }}</td>
            <td class="ratio-cell">{{ formatRatio(row.ev_to_ebitda) }}</td>
            <td class="value-cell">{{ formatCurrency(row.enterprise_value) }}</td>
