      ...
      <table>
        ...
        <tbody>
          ...
          >
            ...
            <td class="value-cell">{{ formatCurrency(row.fcf) }}</td>
            <td class="value-cell">{{ formatCurrency(row.dividends_buybacks) }}</td>
            <td class="value-cell">{{ formatCurrency(row.revenue) }}</td>
            <td class="ratio-cell">{{ formatRatio(row.fcf_to_dividends_buybacks) }}</td>
            <td class="ratio-cell">{{ formatPercentage(row.fcf_to_revenue) }}</td>
...
<style scoped>
.cash-flow-yearly-table {
  width: 100%;
  margin-bottom: 2rem;
}

.cash-flow-yearly-table h3 {
  font-size: 1.25rem;
  font-weight: 700;
  color: #111827;
  margin-bottom: 1rem;
...
tbody tr.red-flag-row {
  /* No background color for red flags */
}
