<template>
  <div class="working-capital-yearly-table">
      ...
      <table>
        ...
        <tbody>
          ...
          >
            ...
            <td class="value-cell">{{ formatNumber(row.dso) }}</td>
            <td class="value-cell">{{ formatCurrency(row.receivables) }}</td>
            <td class="value-cell">{{ formatCurrency(row.revenue) }}</td>
            <td class="ratio-cell">{{ formatPercentage(row.ar_growth) }}</td>
            <td class="ratio-cell">{{ formatPercentage(row.revenue_growth) }}</td>
...
<script>
export default {
  name: 'WorkingCapitalYearlyTable',
  props: {
    yearlyData: {
      type: Array,
      required: true,
