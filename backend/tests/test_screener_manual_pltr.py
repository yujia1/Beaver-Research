"""
Manual test for PLTR to verify channel stuffing risk and other metrics
"""
import os
import pytest
...
def test_pltr_channel_stuffing():
    """Test PLTR for channel stuffing risk"""
    ticker = "PLTR"
    print(f"\nAnalyzing {ticker}...")
